...
const Header =({title,image,type})=> {
    return (
        <div classNmae='w-full h-[100vh]'>
            ...
            <div className='absolute w-full h-full bg-gradient-to-transparent top-0 z-8 flex flex-col items-center justify-center pt-40 2xl:pt-20 px-4'>
